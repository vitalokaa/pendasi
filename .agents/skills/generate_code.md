...
3. *Output*: Dump your code perfectly into the app_build/ directory. Do not skip or summarize any code blocks. Ensure all package.json or requirements.txt files are present.x